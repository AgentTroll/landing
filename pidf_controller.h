...
/**
 * Represents the state held by a PIDF controller.
 */
...
public:
    ...
    /**
     * Updates the time step value to reflect changes in
     * the sensor poll time.
     *
     * @param new_time_step the new time step value
     */
    void set_time_step(double new_time_step);
